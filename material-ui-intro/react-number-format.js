...
function getThousandsGroupRegex(thousandsGroupStyle) {
 ...
 // console.log('getThousandsGroupRegex', thousandsGroupStyle);
...
function roundToPrecision(numStr, scale, fixedDecimalScale) {
  ...
  console.log('roundToPrecision: ',"".concat(negation).concat(intPart).concat(decimalSeparator).concat(decimalPart));
...
function (_React$Component) {
  ...
  _createClass(NumberFormat, [{
    ...
    value: function getFloatString() {
      ...
      var digitalUnit = /[mk]/.exec(num);

      console.log('getFloatString=======');
      console.log('getFloatString', num);
      console.log('getFloatString-digitalUnit',digitalUnit && digitalUnit[0]);
      console.log('getFloatString-props::', this.props);


      num = (num.match(numRegex) || []).join('').replace(decimalSeparator, '.'); //remove extra decimals

      console.log('getFloatString-num', num);


      var firstDecimalIndex = num.indexOf('.');


     // console.log('getFloatString-typeof',  typeof num);
     ...
     // 有小数点
      if (firstDecimalIndex !== -1) {
        ...
        if (!!digitalUnit && digitalUnit[0]) {
          if (digitalUnit[0] == 'm') {
             num = num.slice(0,firstDecimalIndex)+'0000'+num.slice(firstDecimalIndex) 
          }
          if (digitalUnit[0] == 'k') {
             num = num.slice(0,firstDecimalIndex)+'000'+num.slice(firstDecimalIndex) 
          }
        };
    ...
    value: function removePrefixAndSuffix(val) {
      ...
      console.log('removePrefixAndSuffix', val);    
      console.log('removePrefixAndSuffix-props:', this.props);    

      var digitalUnit = /[mk]/.exec(val);

    //  console.log('removePrefixAndSuffix-digitalUnit', digitalUnit);    
    ...
    console.log('removePrefixAndSuffix-return', val);    
    ...
    value: function removeFormatting(val) {
      ...
      if (!format) {
        ...
        console.log('removeFormatting-removePrefixAndSuffix', val);
        val = this.removePrefixAndSuffix(val);
        val = this.getFloatString(val);

        console.log(22223, val);
      ...
      console.log('removeFormatting', val, format, removeFormatting);
    ...
    value: function formatAsNumber(numStr) {
      ...
      console.log('formatAsNumber' ,numStr);
    ...
    value: function formatNumString() {
     ...
     // console.log('formatNumString', arguments);
    //  console.log('formatNumString-numStr:', numStr);
    ...
    value: function formatValueProp(defaultValue) {
      ...
      console.log('formatValueProp', defaultValue)
      console.log('formatValueProp-this.props::', this.props)
      console.log('formatValueProp-value::', value)
      console.log('formatValueProp-_this$props8::', _this$props8)
      ...
      console.log('formatValueProp-formattedValue::', formattedValue)
    ...
    value: function formatInput() {
      ...
      console.log('formatInput-format::', format);


      value = this.removeFormatting(value);

  
      console.log('formatInput-value22::', value);
